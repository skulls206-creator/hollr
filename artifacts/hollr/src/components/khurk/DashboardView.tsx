          ...
          {app.imageSrc ? (
            <div
              ...
              style={{
                ...
                ...(containerStyle.filter ? { filter: containerStyle.filter, transition: 'filter 0.4s ease' } : {}),
              }}
            >
              <img
                src={app.imageSrc}
                ...
                style={{
                  filter: imgFilter
                    ? imgFilter + ' drop-shadow(0 1px 4px rgba(0,0,0,0.6))'
      ...
      >
        {app.imageSrc ? (
          <img
            ...
            style={{
              filter: imgFilter
                ? imgFilter + ' drop-shadow(0 1px 4px rgba(0,0,0,0.5))'
